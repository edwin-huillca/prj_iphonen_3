	var PoiRadar = {
		...
		show: function initFn() {
			...
			AR.radar.background = new AR.ImageResource("assets/radar_bg.png", { onLoaded : function(event){
			  console.log("Radar BG Loaded", event);
			}, onError: function(err){
				console.log("Errror loading image", err);
			}
			});
